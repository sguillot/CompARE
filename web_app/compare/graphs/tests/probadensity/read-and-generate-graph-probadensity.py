...
def generate_contour_plot_from_probadensity(file_path):
    x_values = []
    y_values = []
    ...
    fig.update_layout(
        title='Probability Distribution Plot',
...
generate_contour_plot_from_probadensity('web_app/compare/static/h5/qLMXB_M13_qLMXB_2018_massradius_helium_1_ProbaDistrib.h5')