...
def generate_contour_plot_from_h5(file_path):
    x_values = []
    y_values = []
...
generate_contour_plot_from_h5('web_app/compare/static/h5/qLMXB_47TucX5_qLMXB_2016_massradius_hydrogen_1_Contours.h5')
