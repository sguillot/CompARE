...
no_eos = pd.read_table('data/EoS-insensitive_posterior_samples.dat.gz',
                          delim_whitespace=True)
# reading the high_spin_PhenomPNRT_posterior_samples.dat.gz file
high_spin = pd.read_table('data/high_spin_PhenomPNRT_posterior_samples.dat.gz',
                          delim_whitespace=True)
# reading the low_spin_PhenomPNRT_posterior_samples.dat.gz file
low_spin = pd.read_table('data/low_spin_PhenomPNRT_posterior_samples.dat.gz',delim_whitespace=True)
...
plt.savefig('plot-L1-L2-lowspin.pdf')
#plt.show()
